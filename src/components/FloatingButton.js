...
function FloatingButton({session}) {
    ...
    return (
        <Dropdown backdrop="blur" placement="bottom-end" classNames={{
            ...
            <DropdownTrigger>
                <button className="fixed bottom-5 left-4 w-[45px] h-[45px] text-white rounded-full flex items-center justify-center box-border outline-none bg-[#ff9650] shadow-2xl md:hidden">
