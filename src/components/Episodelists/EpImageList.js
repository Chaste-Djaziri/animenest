          ...
          >
            <div className={`relative w-full flex-1 rounded-lg overflow-hidden bg-[#18181b] aspect-video ${isWatched ? 'opacity-60' : ''}`}>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="hidden group-hover:flex items-center justify-center opacity-0 bg-white bg-opacity-40 hover:bg-[#ff9650] rounded-full shadow group-hover:opacity-90 w-12 h-12">
            ...
            <span className="absolute bottom-2 right-2 bg-[#ff9650] px-[6px] py-[3px] text-xs rounded-md">F</span>
            }
            <span
